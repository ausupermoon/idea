Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n>1)); }, 'strings': {"":{"Size":"Taglia\r\n","@count years":"@count anni","Please wait...":"Attendere prego ...","@device":"\u20ac","Show more":"Pi\u00f9 scelta","Show fewer":"Mostra meno","less choice":"meno scelta","more choice":"Pi\u00f9 scelta","all sizes":"tutte le dimensioni","less sizes":"meno scelta","- Choose category -":"Selezionare una categoria di consigli"}} };;
(function(Drupal, $) {
  "use strict";
